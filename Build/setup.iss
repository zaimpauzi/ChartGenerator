...
#define MyAppSetupName 'CoralLAB'
...
AppCopyright=Copyright © 2019 Neutronsys Solution
VersionInfoVersion={#MyAppVersion}
VersionInfoCompany=Neutronsys Solution
AppPublisher=Neutronsys Solution
;AppPublisherURL=http://...
;AppSupportURL=http://...
;AppUpdatesURL=http://...
OutputBaseFilename=CoralLAB_v1.0_setup
...
[Files]
Source: "C:\Repo\FRITool\ChartGenerator\bin\Release\CoralLAB.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Repo\FRITool\ChartGenerator\bin\Release\CoralLAB.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Repo\FRITool\ChartGenerator\bin\Release\OxyPlot.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Repo\FRITool\ChartGenerator\bin\Release\OxyPlot.Wpf.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Repo\FRITool\ChartGenerator\bin\Release\OxyPlot.Wpf.xml"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Repo\FRITool\ChartGenerator\bin\Release\OxyPlot.xml"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{group}\{#MyAppSetupName}"; Filename: "{app}\CoralLAB.exe"
Name: "{group}\{cm:UninstallProgram,{#MyAppSetupName}}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\{#MyAppSetupName}"; Filename: "{app}\CoralLAB.exe"; Tasks: desktopicon
...
[Run]
Filename: "{app}\CoralLAB.exe"; Description: "{cm:LaunchProgram,{#MyAppSetupName}}"; Flags: nowait postinstall skipifsilent
